...
/**
 * Редактирование голосовой команды.
 *
...
class UpdateAction extends CAction
{
    public function run()
    {
        if(!Yii::app()->user->checkAccess('updateIvrCommandTelephony')) {
        ...
        $controller->pageTitle = Yii::app()->name .' | Телефония | Редактирование голосовой команды';
