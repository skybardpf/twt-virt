...
<div class="breadcrumbs breadcrumb">
	<?php
	echo CHtml::link($this->company->name, $this->createUrl('user',array('company_id' => $this->company->id))).' :/ ';
	foreach ($ancestors as $ancestor) {
		if ($ancestor->lvl != 1) {
			echo CHtml::link($ancestor->name, $this->createUrl('user',array('company_id' => $this->company->id, 'dir_id' => $ancestor->id))).' / ';
		}
	}
